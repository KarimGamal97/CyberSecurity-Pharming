...
let points = 0;
let pointsPercentage = (points / 9) * 100;
...
const endTest = () => {
  ...
  finalResult.style.background = `conic-gradient(${circleColor} ${circlePercentage}deg, #ededed ${circlePercentage + 5
    }deg)`;
